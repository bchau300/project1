        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                        ...
                        <?php
                            ...
                            if(isset($_POST["FName"]) && isset($_POST["LName"]))
                            {
                                ...
                                if($Checking["Pass"]==$pass)
                                {
                                    ...
                                    $sql = "INSERT INTO patients(PatientFNAME, PatientLNAME, APPDATE, PatientTIME, PatientLOCATION, PatientPN, PATSTATUS, HYGIENIST)
                                    values(\"" . $FName . "\",\"" . $LName . "\",\"" . $Date . "\",\"" . $PatientTime . "\",\"" . $PatientLocation . "\",\"" . $PatientPN ."\",  4,\"".  $Hygen . "\")";
                                    $result = mysqli_query($conn, $sql);
                                    mysqli_query($conn, "INSERT INTO Sixmonthreminder(PatientFNAME, PatientLNAME, APPDATE, PatientTIME, PatientLOCATION, PatientPN)
                                    values(\"" . $FName . "\",\"" . $LName . "\",\"" . $Date . "\",\"" . $PatientTime . "\",\""  . $PatientLocation . "\",\"" . $PatientPN ."\")");
                                    if($result)
                                    {
                                        echo "<h5>Success! " . $FName . " " . $LName . " is checked in!</h5>";
                                    }
                                    else
                                    {
                ...
                <div class="row">
                    ...
                    <input class="btn btn-primary" type="submit" name="submitAdd" id="submitAdd" value="Update Stats">
                    </form>
